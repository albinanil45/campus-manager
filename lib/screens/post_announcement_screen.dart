...
class PostAnnouncementScreen extends StatefulWidget {
  ...
  PostAnnouncementScreen({super.key, required this.announcementService, required this.user});
      ...
      return SingleChildScrollView(
        ...
        child: Center(
          child: ConstrainedBox(
            ...
            child: IntrinsicHeight( // Helps the column take up only the required height
              child: Column(
                    ...
                    builder: (context, value, child) {
                      return SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: ()async{
                            isLoading.value ? null : await postAnnouncement(context);
                          },
